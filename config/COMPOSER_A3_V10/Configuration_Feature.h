...
#define CHAMBERFAN_SPEED2         	180 // 255 = full speed
...
#define CHANGE_T0      {{-20.0,  297,   200,  true},\
						{-46.0,  297,   200,  true},\
						{-46.0,  264.4,  50,  true},\
						{-36.0,  264.4, 200,  true},\
						{-36.0,  214,   200, false},\
...
#define CHANGE_T1      {{-20.0, 114.0, 200, false},\
						{-46.0, 114.0, 200, false},\
						{-46.0, 204.0,  40, false},\
						{-46.0, 224.0, 200,  true},\
						{-46.0, 260.0,  50,  true},\
						{-20.0, 260.0, 200,  true},\
...
#define SDSORT_GCODE       true  // Allow turning sorting on/off with LCD and M36 g-code.
 ...
 *      0 : No delay at all - But, at least 10�s are expected          *
