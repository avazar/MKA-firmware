...
constexpr MCode_t MCode_Table [] = {
		...
		{1001, gcode_M1001},
	#endif
	#if ENABLED(CODE_M1002)
		{1002, gcode_M1002},
	#endif
	#if ENABLED(CODE_M1003)
		{1003, gcode_M1003},
	#endif
	#if ENABLED(CODE_M1004)
		{1004, gcode_M1004},
	#endif
	#if ENABLED(CODE_M1005)
		{1005, gcode_M1005},
	#endif
	#if ENABLED(CODE_M1006)
		{1006, gcode_M1006},
	#endif
	#if ENABLED(CODE_M1007)
		{1007, gcode_M1007},
	#endif
	#if ENABLED(CODE_M1008)
		{1008, gcode_M1008},
	#endif
	#if ENABLED(CODE_M1009)
		{1009, gcode_M1009},
	#endif
	#if ENABLED(CODE_M1010)
		{1010, gcode_M1010},
	#endif
	#if ENABLED(CODE_M1011)
		{1011, gcode_M1011},
	#endif
		...
		{1013, gcode_M1013},
	#endif
	#if ENABLED(CODE_M1014)
		{1014, gcode_M1014},
	#endif
	#if ENABLED(CODE_M1015)
		{1015, gcode_M1015},
	#endif
	#if ENABLED(CODE_M1016)
		{1016, gcode_M1016},
	#endif
	#if ENABLED(CODE_M1017)
		{1017, gcode_M1017},
	#endif
	#if ENABLED(CODE_M1018)
		{1018, gcode_M1018},
	#endif
	#if ENABLED(CODE_M1019)
		{1019, gcode_M1019},
	#endif
	#if ENABLED(CODE_M1020)
		{1020, gcode_M1020},
	#endif
	#if ENABLED(CODE_M1021)
		{1021, gcode_M1021},
	#endif
	#if ENABLED(CODE_M1022)
		{1022, gcode_M1022},
	#endif
